...
<%--           <img src="${pageContext.request.contextPath}/assets/img/brand/while.jpg" /> --%>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="${pageContext.request.contextPath}/examples/register.html">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Maximiner Analytics Pvt Ltd Bengaluru.</p>
            </div>
          </div>
        </div>
      </div>
