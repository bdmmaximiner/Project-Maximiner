...
<body>
		...
		<div class="container-fluid">
				...
				<li class="nav-item dropdown"><a class="nav-link" href="#"
					...
					<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
						...
						<a href="${pageContext.request.contextPath}/examples/profile.html"
							...
							href="${pageContext.request.contextPath}/examples/profile.html"
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/examples/icons.html">
							<i class="ni ni-planet text-blue"></i> Icons
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/examples/maps.html">
					...
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/examples/tables.html">
							<i class="ni ni-bullet-list-67 text-red"></i> Tables
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/examples/login.html">
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark"
			...
			<div class="container-fluid">
				...
				<a
					...
					href="${pageContext.request.contextPath}/index.html">Dashboard</a>
				<!-- Form -->
				<form
	...
	<!-- Argon JS -->
	<script
		src="${pageContext.request.contextPath}/assets/js/argon.js?v=1.0.0"></script>
</body>
