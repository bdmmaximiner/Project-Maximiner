	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			stmt.executeQuery("DECLARE \r\n" + "    NCOUNT NUMBER; \r\n" + "    V_SQL  LONG; \r\n"
					...
					+ "      V_SQL := '  CREATE TABLE MSIGNUP(  SID NUMBER(15) NOT NULL , First_Name VARCHAR2(50) NOT NULL  ,Last_Name VARCHAR2(50) NOT NULL,  Contact_no NUMBER(15) NOT NULL  ,User_Name VARCHAR2(50) NOT NULL, Designation VARCHAR2(50) NOT NULL, EMAIL VARCHAR2(50) NOT NULL  , MESSAGE VARCHAR2(500) NOT NULL  , CONSTRAINT ENQUIRY_PK PRIMARY KEY (ID)  ENABLE )'; \r\n"
					+ "\r\n" + "      V_SQL1 := \r\n"
